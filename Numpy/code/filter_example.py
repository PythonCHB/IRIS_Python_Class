...
def convert_2d_window(input, width):
    """
    returns a 2-d array, converted with stride_tricks from the input array,
    to provide a moving window
    
    the resulting 2-d array is size: (length, width_of_window), so that you
    can do vector math over the window
